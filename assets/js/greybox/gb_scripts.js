...
GB_Gallery=GreyBox.extend({
    ...
    setFrameSize:function(){
        ...
        if (this.width>=window.innerWidth-100){
            ...
            h=this.height*window.innerWidth/this.width;
            this.width=t;
            this.height=h;
        }
        if (this.height>=window.innerHeight-120){
            h=window.innerHeight-120;
            t=this.width*window.innerHeight/this.height;
            this.width=t;
            this.height=h;
            if (this.width>=window.innerWidth-100){
                t=window.innerWidth-100;
        ...
        AJS.setHeight(this.iframe,h);
        AJS.setWidth(this.iframe,t);
        AJS.setWidth(this.header,window.innerWidth)
    },
...
GB_showCenter('Claim Application form',url,500,600,closeBack);

if(document.getElementById('txtEmployeeId')){
    document.getElementById('txtEmployeeId').style.display='none';
}
document.getElementById('txtExpenseTitle').style.display='none';
document.getElementById('txtFwdEmployeeId').style.display='none';


function closeBack(){
    document.getElementById('txtExpenseTitle').style.display='';
    document.getElementById('txtFwdEmployeeId').style.display='';
    if(document.getElementById('txtEmployeeId'))
    {
        document.getElementById('txtEmployeeId').style.display='';
    }
}
